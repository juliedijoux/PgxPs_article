...
# GCTGCGTTCTTCATCGATGC REV (5'-3') ITS-2R revcomp: GCATCGATGAAGAACGCAGC

for f in *_2_[1,2].fastq.gz

do
    n=${f%%_2_[1,2].fastq.gz}
    cutadapt -g CTTGGTCATTTAGAGGAAGTAA -a GCATCGATGAAGAACGCAGC \
    -G GCTGCGTTCTTCATCGATGC -A TTACTTCCTCTAAATGACCAAG -n 2 \
