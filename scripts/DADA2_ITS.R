...
path <- "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS/cut_fastq" # variable that tells us where to retrieve the fastq
...
#svg(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotquali_sample1_sens.svg") # Saves the next plot in svg format
...
#svg(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotquali_sample1_antisens.svg") # Saves the next plot in svg format
#plotQualityProfile(fnRs[1]) # display of the Qscore associated with each nucleotide in the 1st antisense sample
#dev.off() # to delete the plot

pdf(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotquali_agregate_sens.pdf") # Saves the next plot in pdf format
plotQualityProfile(fnFs, aggregate = TRUE) # visualisation of the Qscore associated with each nucleotide for all sense samples
dev.off() # to delete the plot
pdf(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotquali_agregate_antisens.pdf") # Saves the next plot in pdf format
...
save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part1.RData") # save the entire environment in the chosen directory

########## Part 2 ##########

setwd(dir = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS/cut_fastq")
#load("/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part1.RData") # Loading the R environment
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs,
                     ...
                     truncLen = c(170,170), # truncLen = defines the length at which sequences will be truncated; sequences shorter than the length are eliminated
...
save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part2.RData") # save the entire environment in the chosen directory

########## Part 3 ##########

#load("/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part2.RData") # Loading the R environment
...
save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part3.RData") # save the entire environment in the chosen directory
...
save(seqtab.nochim, file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/biostat_analysis/0_DADA2_output/seqtab.nochim_ITS.rdata")
...
save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part4.RData") # save the entire environment in the chosen directory
...
save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part5.RData") # save the entire environment in the chosen directory
...
save(taxotab, file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/biostat_analysis/0_DADA2_output/taxo_tab_ITS.rdata")

save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part6.RData") # save the entire environment in the chosen directory