...
#setwd("/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS/cut_fastq")

########## Partie 1 ##########

path <- "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS/cut_fastq" # variable qui nous indique où récupérer les fastq
...
#svg(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotquali_sample1_sens.svg") # Permet de sauvegarder le prochain plot sous format svg
...
#svg(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotquali_sample1_antisens.svg") # Permet de sauvegarder le prochain plot sous format svg
#plotQualityProfile(fnRs[1]) # visualisation du Qscore associé à chaque nucléotides du 1er échantillon antisens
#dev.off() # pour supprimer le plot

pdf(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotquali_agregate_sens.pdf") # Permet de sauvegarder le prochain plot sous format svg
plotQualityProfile(fnFs, aggregate = TRUE) # visualisation agrégée du Qscore associé à chaque nucléotides sens
dev.off() # pour supprimer le plot
pdf(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotquali_agregate_antisens.pdf") # Permet de sauvegarder le prochain plot sous format svg
plotQualityProfile(fnRs, aggregate = TRUE) # visualisation agrégée du Qscore associé à chaque nucléotides antisens
dev.off() # pour supprimer le plot

save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part1.RData") # sauvegarde de tout l'environnement dans le répertoire choisi

########## Partie 2 ##########

setwd(dir = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS/cut_fastq")
load("/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part1.RData") # Chargement de l'environnement R.
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs,
                     ...
                     truncLen = c(170,170), # truncLen = définit à quelle longueur les séquences vont être tronquées ; les séquences les plus courtes que la longueur sont éliminées.
...
pourc_disc
write.table(pourc_disc, file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_tab/pourc_seqTrimmed_sur_seq_noTrimmed_ITS.csv", sep=";", col.names = NA)
...
write.table(pourc_disc, file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_tab/suivi_filterAndTrim_ITS.csv", sep=";", col.names = NA)

save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part2.RData") # sauvegarde de tout l'environnement dans le répertoire choisi

########## Partie 3 ##########

#load("/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part2.RData") # Chargement de l'environnement R.
...
pdf(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotErrors_sens_ITS.pdf")
plotErrors(errF, nominalQ = TRUE) # visualisation du taux d'erreur de séquençage des sens
dev.off()
pdf(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/plotErrors_antisens_ITS.pdf")
...
save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part3.RData") # sauvegarde de tout l'environnement dans le répertoire choisi

########## Partie 4 ##########

#load("/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part3.RData")
...
seqtab
save(seqtab, file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_tab/seqtab_ITS.rdata")

pdf(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/hist_ASVsLength_ITS.pdf")
...
seqtab.nochim <- removeBimeraDenovo(seqtab, 
                                    ...
                                    multithread = TRUE,
                                    verbose = TRUE) 
save(seqtab.nochim, file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_tab/seqtab.nochim_ITS.rdata")
save(seqtab.nochim, file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/biostat_analysis/seqtab.nochim_ITS.rdata")
...
write.table(suivi_dechim, file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_tab/suivi_dechim_ITS.csv", sep=";", col.names = NA)

pdf(file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_figures/hist_NonChimericASVsLength_ITS.pdf")
...
save(seqtab.nochim.bin, file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_tab/seqtab.nochim.bin_ITS.rdata")

save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part4.RData") # sauvegarde de tout l'environnement dans le répertoire choisi

########## Partie 5 ##########

#load("/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part4.RData")
...
head(track)
write.table(track, file="/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_tab/table_suivi_ITS.csv", sep=";", col.names = NA)

save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part5.RData") # sauvegarde de tout l'environnement dans le répertoire choisi

########## Partie 6 ##########

#load("/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part5.RData")
setwd("/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/DB_taxo")

taxotab <- assignTaxonomy(seqtab.nochim,
                          refFasta = "sh_general_release_dynamic_s_all_25.07.2023.fasta",
                          minBoot = 50, # Par défaut = 50. Bootsrap minimum (représente le niveau de confiance pour l'assignation à un rang taxonomique).
                          multithread=TRUE)

save(taxotab, file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_tab/taxo_tab_ITS.rdata")
save(taxotab, file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/biostat_analysis/taxo_tab_ITS.rdata")

save(list = ls(), file = "/home/unc/jdijoux/NGS_analysis_Pg.Ps/work/ITS_env/env_entier_ITS_dada2_part6.RData") # sauvegarde de tout l'environnement dans le répertoire choisi
