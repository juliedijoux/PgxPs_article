...
setwd(dir = "C:/Users/jdijoux/Pictures/Rédaction ARTICLE 22-09-2024/biostat_analysis") # Set directory

# Out folder creation
path <- "C:/Users/jdijoux/Pictures/Rédaction ARTICLE 22-09-2024/biostat_analysis"
...
path <- "C:/Users/jdijoux/Pictures/Rédaction ARTICLE 22-09-2024/biostat_analysis/6_editing_figures"
...
all_MDS <- function(libraries, method, nk) {
  ...
  write.table(matrix_morisita,
    file = paste0("6_editing_figures/beta_diversity/matrix_", method, "_", libraries, ".csv"),
    sep = ";",
    col.names = NA
  )
...
dend.cah <- function(libraries, method, distance, clusters) {
  ...
  pdf(
    file = paste0("6_editing_figures/beta_diversity/dendrogram_", method, "_", clusters, "_", libraries, ".pdf"),
  ...
  if (libraries == "16S") {
    ...
    text(
      x = 50.5, y = -0.64,
      labels = "k4_F", pos = 3, font = 2, cex = 0.3
    )
    text(
      x = 58, y = -0.64,
    ...
    # Part 3: add the horizontal line and its label
    abline(h = matrix.cwo$height[length(matrix.cwo$height) - 2], lty = 2, col = "red", lwd = 1)
    text(x = 1.3, y = round(matrix.cwo$height[length(matrix.cwo$height) - 2], 0)-0.15, labels = paste0("distance = ", round(matrix.cwo$height[length(matrix.cwo$height) - 2], 1)), pos = 3, col = "red", cex = 0.5)
  }
  dev.off()
}
...
path <- "C:/Users/jdijoux/Pictures/Rédaction ARTICLE 22-09-2024/biostat_analysis/6_editing_figures/co-occurence_network"
newfolder <- "BF_tables"
...
path <- "C:/Users/jdijoux/Pictures/Rédaction ARTICLE 22-09-2024/biostat_analysis/6_editing_figures/co-occurence_network/SpMan_network"
